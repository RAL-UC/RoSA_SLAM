...
XMAX_m = 50#134 # 90[m] world width
YMAX_m = 28#90 # 22[m] world height
...
THETA_MX, THETA_MN, D_MX, D_MN = 3.0, -3.0, S_MAX_RANGE, 0.50 #np.pi, -np.pi, 30.0, 0.50#2.45, -2.45, 100.0,  0.5
