...
def join_scan_data_plus4(points0, points1, points2, points3,theta_max, theta_min, d_max, d_min):
    lidar_scan0 = make_data_polar_filter_coord(points0, theta_max, theta_min, d_max, d_min)
    lidar_scan1 = make_data_polar_filter_coord(points1, theta_max, theta_min, d_max, d_min)
    lidar_scan2 = make_data_polar_filter_coord(points2, theta_max, theta_min, d_max, d_min)
    lidar_scan3 = make_data_polar_filter_coord(points3, theta_max, theta_min, d_max, d_min)
    lidar_data = np.concatenate((lidar_scan0, lidar_scan1, lidar_scan2, lidar_scan3))
    points_map0 = join_scan2map_min(points0, points1)
    points_map1 = join_scan2map_min(points2, points3)
    points_map2 = join_scan2map_min(points_map0, points_map1)
    mapa_data = make_data_for_occmap_plus(points_map2, theta_max, theta_min, d_max, d_min)
    return lidar_data, mapa_data
